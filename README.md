...
<p align="center">
  <em>Chasing Cybersecurity 🛡️ | Networking 🌐 | Development 💻</em>
</p>
...
| 🔒 Love **bug hunting** | 🐧 Hardcore **Linux user & automation enthusiast** |
| ⚛ React Specialist | 📡 Exploring **cloud security and DevSecOps** |

## 🚀 Tech Stack & Core Skills

> _Crafted with Code. Secured with Logic. Deployed with Precision._
...
### 🐧 Linux & DevOps
- 🖥️ **Linux Administration** – Arch, Ubuntu, Kali  
- 🐳 **Docker**, ☸️ **Kubernetes**, 🌐 **Nginx**  
- ⚙️ Bash Scripting & Workflow Automation
